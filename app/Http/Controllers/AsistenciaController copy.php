...
class AsistenciaController extends Controller
{
    ...
    public function index()
    {
        ...
        $asistencias = Asistencia::with('docente')->get();

        // Ahora puedes acceder a los docentes relacionados de cada asistencia
        foreach ($asistencias as $asistencia) {
            $user = Auth::user();
            $docentes = $asistencia->docentes;
            $departamento_grado = $user->departamento;
            print($docentes->departamento );
            print($docentes->id);
            // Realiza las operaciones que necesites con $docente
        }
        ...
        //     $asistencia_departamento[] = $asistencias->docentes->departamento;
        //     dd($asistencia_departamento);
